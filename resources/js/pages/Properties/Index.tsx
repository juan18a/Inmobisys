...
const STATUS_LABELS = {
    ...
    sold: { label: 'Vendido', color: 'bg-slate-100 text-slate-700' },
    rented: { label: 'Rentado', color: 'bg-blue-100 text-blue-700' },
...
export default function PropertiesIndex({ properties, filters }: Props) {
    ...
    // IMPORTANTE: Mapear las propiedades para que tengan los campos img, location, etc.
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-2xl font-bold font-headline text-secondary">Gestión de Propiedades</h1>
                ...
                {properties.last_page > 1 && (
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 mt-auto border-t border-neutral-100">
                        <p className="text-sm text-neutral-500">
                            Mostrando <span className="font-bold text-secondary">{properties.from}–{properties.to}</span> de <span className="font-bold text-secondary">{properties.total}</span> propiedades
                        </p>
